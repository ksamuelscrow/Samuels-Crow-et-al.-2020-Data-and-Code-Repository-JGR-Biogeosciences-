...
X2  = cbind(X1[,1]*X1[,2], X1[,1]*X1[,3], X1[,1]*X1[,5], X1[,1]*X1[,6], X1[,2]*X1[,3], X1[,2]*X1[,5], X1[,2]*X1[,6], X1[,3]*X1[,5], X1[,3]*X1[,6], X1[,5]*X1[,6]) #Interactions incorporated into linear model used to estimate initial values
...
jm1.b=jags.model("JAGSModel_SAM_SamuelsCrowetal_JGR_2020.R",
                 data=data,
                 n.chains=n.chains,
                 n.adapt=n.adapt,
                 inits = inits)
